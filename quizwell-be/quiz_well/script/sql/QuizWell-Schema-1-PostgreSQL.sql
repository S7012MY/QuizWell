...
-- Created on Sat Feb 17 16:20:30 2024
--
--
-- Table: questions
--
...
CREATE INDEX question_answers_idx_answer_id on question_answers (answer_id);
...
ALTER TABLE question_answers ADD CONSTRAINT question_answers_fk_answer_id FOREIGN KEY (answer_id)
  REFERENCES quiz_answers (id) DEFERRABLE;
...
ALTER TABLE quiz_answers ADD CONSTRAINT quiz_answers_fk_answer_id FOREIGN KEY (answer_id)
  REFERENCES question_answers (id) DEFERRABLE;
